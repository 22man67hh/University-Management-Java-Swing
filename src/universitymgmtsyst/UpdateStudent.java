  ...
  Choice crollno;
    public UpdateStudent() {
        ...
        try {
         ...
         JLabel lblsemester = new JLabel("UpGrade Semester:");
        lblsemester.setBounds(470, 100, 200, 30);
        ...
        cbsem.setBounds(650, 100, 150, 20);
                ...
                lbldoc.setText(rs.getString("dob"));
                 tfaddress.setText(rs.getString("address"));
                  tfphone.setText(rs.getString("phone"));
                   ...
                   tfac.setText(rs.getString("faculty"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
   ...
   crollno.addItemListener(new ItemListener(){
      ...
      public void itemStateChanged(ItemEvent e){
        ...
        upgrade.setBounds(110, 550, 120, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
 String query = "UPDATE student SET address = ?, phone = ?, email = ?, course = ?, faculty = ? WHERE rollno = ?";                Conn con = new Conn();
            ...
            try {
 String query = "UPDATE student SET address = ?, phone = ?, email = ?, course = ?, faculty = ? pay=? WHERE rollno = ?";                Conn con = new Conn();
                PreparedStatement ps = con.c.prepareStatement(query);
